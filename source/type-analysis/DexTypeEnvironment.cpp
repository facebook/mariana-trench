 ...
 */
const DexType* MT_NULLABLE find_common_super_class(const DexType* l,
                                                   const DexType* r) {
  always_assert(l && r);
  if (l == r) {
    return l;
...
const DexType* MT_NULLABLE find_common_type(const DexType* l,
                                            const DexType* r) {
 ...
 */
const DexType* MT_NULLABLE find_common_array_type(const DexType* l,
                                                  const DexType* r) {
