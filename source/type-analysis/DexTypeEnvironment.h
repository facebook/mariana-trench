...
class DexTypeValue final : public sparta::AbstractValue<DexTypeValue> {
 public:
  ...
  DexTypeValue(const DexTypeValue&) = default;
  DexTypeValue(DexTypeValue&&) = default;
  DexTypeValue& operator=(const DexTypeValue&) = default;
  DexTypeValue& operator=(DexTypeValue&&) = default;
...
class SmallSetDexTypeDomain final
 ...
 public:
  ...
  [[noreturn]] void meet_with(const SmallSetDexTypeDomain& /* other */) {
    throw std::runtime_error("meet_with not implemented!");
  }

  [[noreturn]] void narrow_with(const SmallSetDexTypeDomain& /* other */) {
