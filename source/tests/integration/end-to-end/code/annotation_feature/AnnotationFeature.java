 ...
 */
 ...
 public class AnnotationFeature {
   ...
   @Path("/issue_3")
   void forAllParameterSourceWithLabel(@QueryParam("query_param_1") String param1, @OtherQueryParam(value = "other_query_param_1", description = "description_instead_of_value") String otherQueryParam1, @OtherQueryParam("other_query_param_2") String otherQueryParam2) {
